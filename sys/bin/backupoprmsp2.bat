@echo off
REM
REM $Header: /jbs/var/cvs/orascripts/bin/backupoprmsp2.bat,v 1.1.1.1 2012/12/28 17:34:15 jim Exp $
REM 
REM $Log: backupoprmsp2.bat,v $
...
REM 
REM ========================================================
echo backupoprmsp2.bat $Revision: 1.1.1.1 $
echo .
pushd
