@echo off
REM
REM $Header: /jbs/var/cvs/orascripts/bin/backupoprmsp3.bat,v 1.1.1.1 2012/12/28 17:34:15 jim Exp $
REM 
REM $Log: backupoprmsp3.bat,v $
...
REM
REM Revision 1.1  2005/11/15 14:34:40  jim.smith
REM First checked in version
REM
REM 
REM ========================================================
echo backupoprmsp3.bat $Revision: 1.1.1.1 $
echo .
pushd
