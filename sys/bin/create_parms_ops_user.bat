@echo off
REM
REM $Header: /jbs/var/cvs/orascripts/bin/create_parms_ops_user.bat,v 1.1.1.1 2012/12/28 17:34:15 jim Exp $
REM
REM $Log: create_parms_ops_user.bat,v $
...
echo create_parms_ops_user.bat $Revision: 1.1.1.1 $
echo .
pushd
...
set PASSWORD=elex0n
sqlplus %user%/%pass% @%ELX_SQLDIR%\create_parms_ops_user %newuser% %PASSWORD%
