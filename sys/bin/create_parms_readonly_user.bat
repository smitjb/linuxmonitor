@echo off
REM
REM $Header: /jbs/var/cvs/orascripts/bin/create_parms_readonly_user.bat,v 1.1.1.1 2012/12/28 17:34:15 jim Exp $
REM
REM $Log: create_parms_readonly_user.bat,v $
...
REM
REM Revision 1.2  2005/08/15 13:04:08  jim.smith
...
REM
REM Revision 1.1  2005/05/26 09:25:54  jim.smith
REM First tested version
REM
REM
REM =====================================================================

echo create_parms_readonly_user.bat $Revision: 1.1.1.1 $
echo .
pushd
...
set PASSWORD=elex0n
sqlplus %user%/%pass% @%ELX_SQLDIR%\create_parms_readonly_user %newuser% %PASSWORD%
