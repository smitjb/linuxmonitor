@echo off
REM
REM $Header: /jbs/var/cvs/orascripts/bin/startup_all_parms.bat,v 1.1.1.1 2012/12/28 17:34:15 jim Exp $
REM 
REM $Log: startup_all_parms.bat,v $
...
call startup_parms C: "\Program Files\PARMS\Data Receipt and Despatch"
f:
echo Shutting down Parallel environment
call startup_parms E: "\PARMS\Data Receipt and Despatch"
