...
rem
spool rollback.lis
ttitle center 'ROLLBACK STATISTICS' skip 1
ttitle off
select 'GETS  - # of gets on the rollback segment header: '||sum(gets)||&cr||
	...
	from v$rollstat;
col name format a20 heading "Segment|Name"
...
col aveshrink format 99999999 heading "Av|Shr"
set heading on
select name,
	waits,
...
select 'If # Shrink is low:'||&cr||
	...
	'    If AvShr is high: Good value for OPTIMAL.'||&cr||
